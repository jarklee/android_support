...
public abstract class SwipeCheckableAdapter<VH extends ArrayAdapter.ViewHolder<DATA>, DATA>
        extends ArrayAdapter<VH, DATA>
    ...
    protected final ISwipeCheckableAdapterItemManager mItemManager;

    public SwipeCheckableAdapter(Context context, ISwipeCheckableAdapterItemManager itemManager) {
        super(context);
