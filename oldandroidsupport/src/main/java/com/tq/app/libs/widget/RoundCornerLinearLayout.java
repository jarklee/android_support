...
public class RoundCornerLinearLayout extends LinearLayout {
    ...
    private void loadStateFromAttrs(AttributeSet attributeSet) {
        ...
        TypedArray a = null;
        try {
            a = getContext().obtainStyledAttributes(attributeSet, R.styleable.RoundCornerLayout);
            mRadius = a.getDimensionPixelSize(R.styleable.RoundCornerLayout_r_radius, DEFAULT_RADIUS);
        } finally {
            if (a != null) {
                a.recycle();
            }
