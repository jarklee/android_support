...
import com.tq.app.libs.adapter.ArrayAdapter;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

public abstract class SelectableAdapter<VH extends ArrayAdapter.ViewHolder<DATA>, DATA>
        extends ArrayAdapter<VH, DATA> implements ISelectableItemManager, ISelectableAdapterManager {

    private final ISelectableAdapterItemManager mItemManager;

    public SelectableAdapter(Context context, ISelectableAdapterItemManager itemManager) {
        super(context);
    ...
    protected ISelectableAdapterItemManager getItemManager() {
        return mItemManager;
    }
    ...
    public List<DATA> getSelectedData() {
        ...
        for (Integer position : selectedItems) {
            selectedDataList.add(getItem(position));
        }
    ...
    public void onBindViewHolder(VH holder, int position) {
        ...
        mItemManager.bindView(holder.getItemView(), position);
    }
