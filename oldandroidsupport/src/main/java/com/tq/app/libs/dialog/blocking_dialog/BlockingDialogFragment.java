...
public final class BlockingDialogFragment extends DialogFragment implements IBlockingDialogView {
    ...
    private IBlockingDialogPresenter mPresenter;
    ...
    public static BlockingDialogFragment newInstance() {
        return new BlockingDialogFragment();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mPresenter == null) {
            mPresenter = new BlockingDialogPresenterImpl();
    ...
    @Override
    public void showWhileExecuting(String message, Runnable taskRunnable, Runnable completeTask, Runnable failedTask, String TAG) {
        setMessage(message);
