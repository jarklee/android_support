 ...
 *  Author TrinhQuan. Create on 2016/4/6
 * ******************************************************************************
 */
...
public class ComplexItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public ComplexItemDecorator(Context context, int orientation) {
